...
{
    double novo_total;
    printf("\nSaldo anterior da poupanca em [%d/%d/%d]:%lf",logado.poupanca.ultimo_acesso.dia,logado.poupanca.ultimo_acesso.mes,logado.poupanca.ultimo_acesso.ano,logado.saldo);
