...
t_cliente*logado;
{
    ...
    while(continuar)
    {
        ...
        else printf("\n Seu saldo [R$%.2lf] é insuficiente, digite um valor disponivel em sua conta!",logado->saldo);
    }
    logado->saldo-=valor;
...
int qtd_clientes; //variavel global com a quantidade de clientes do banco//
...
int main()
{
    ...
    qtd_clientes = recebe_arq_principal(lista);
